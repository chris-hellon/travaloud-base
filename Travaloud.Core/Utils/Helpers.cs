...
namespace Travaloud.Core.Utils
{
    public static class Helpers
    {
        ...
        {
            if (httpContextAccessor.HttpContext is {User: { }} && httpContextAccessor.HttpContext?.User.FindFirst(ClaimTypes.NameIdentifier) != null && httpContextAccessor.HttpContext?.User.FindFirst(ClaimTypes.NameIdentifier)?.Value != null)
            {
